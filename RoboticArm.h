...
// Length of memorymapped IO window
...
class RoboticArm                                                                  
{                                                                                 
   int fd; // File descriptor for memorymapped I/O                                                
   char *pBase;   // Mapped address                                                                
   // Write a value into the given memory offset in the memorymapped I/O.  
   void RegisterWrite(unsigned offset, unsigned value);  
   // Read a value from the given memory offset in the memorymapped I/O.  
   int RegisterRead (unsigned offset);                      
                                                                                                   
public:                                                                                            
   RoboticArm();  // Class constructor                                                             
   ~RoboticArm(); // Class Destructor                                                     
